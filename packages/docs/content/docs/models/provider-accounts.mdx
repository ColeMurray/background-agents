...
![Settings, Accounts: connected Claude, ChatGPT, and SuperGrok accounts, each Ready and default for automation, and the Automated sessions credential pickers](/images/models/provider-accounts.webp "Settings › Accounts: connected provider accounts and which credential automated sessions use.")
