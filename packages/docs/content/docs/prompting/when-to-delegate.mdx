...
The sandbox gives the agent a full development environment: Node.js 22, Python 3.12, Bun, git, the GitHub CLI, and `agent-browser` with headless Chromium for screenshots and UI verification. If the task can be validated by running something in that environment, it is a good candidate.
