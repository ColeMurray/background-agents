...
- For repository-scoped servers, at least one connected repository. The form shows "No repositories available. Connect a GitHub integration first." otherwise.
...
Go to Settings › MCP Servers and open New MCP Server.
