...
![Settings, Secrets: a repository scope picker and a list of secret names with masked values, Delete buttons, and Add secret and Save secrets buttons](/images/configure/secrets.webp "Settings › Secrets. Values are write-only; paste a .env block into either field to import several at once.")
