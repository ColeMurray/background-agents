...
![Settings, Audit log: a list of Request authorized events with actor, resource, request id, reason, and a Structured details toggle](/images/administration/audit-log.webp "Settings › Audit log lists events newest first with the actor, resource, and authorization reason.")
