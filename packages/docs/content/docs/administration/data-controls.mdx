...
![Settings, Data Controls: the Archived chats list with a title, age, and repository per row](/images/administration/data-controls.webp "Settings › Data Controls lists archived sessions so you can restore them.")
