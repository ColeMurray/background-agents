...
This module handles:
- WebSocket connection to control plane (Rivet actor routing)
- Heartbeat loop for connection health
- Event forwarding from OpenCode to control plane
- Command handling from control plane (prompt, stop, snapshot, shutdown)
...
class AgentBridge:
    ...
    def ws_url(self) -> str:
        ...
        Connects to: {CONTROL_PLANE_URL}/sessions/{SESSION_ID}/ws?type=sandbox
        The Rivet actor handles the connection routing.
        """
