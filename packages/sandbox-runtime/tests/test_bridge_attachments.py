...
def test_build_attachment_parts_skips_unsupported_media(bridge: AgentBridge) -> None:
    parts = bridge._build_attachment_parts(
...
async def test_hydrate_upload_attachments_rejects_video(bridge: AgentBridge) -> None:
    result = await bridge._hydrate_upload_attachments(
