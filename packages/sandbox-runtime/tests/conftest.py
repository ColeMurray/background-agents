...
def isolate_runtime_file_paths(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "sandbox_runtime.repository_boot.BOOT_WARNINGS_FILE_PATH", boot_warnings_path
    )
    ...
    monkeypatch.setattr("sandbox_runtime.repository_boot.TUNNEL_ENV_FILE_PATH", tunnel_env_path)
