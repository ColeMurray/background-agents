...
export type ArtifactType = "pr" | "screenshot" | "video" | "preview" | "branch" | "file";
...
/** Metadata stored on downloadable file artifacts generated by the agent. */
export interface FileArtifactMetadata {
  /** R2 object key */
  objectKey: string;
  /** Original or sanitized filename */
  filename: string;
  /** MIME type used when downloading */
  mimeType: string;
  /** File size in bytes */
  sizeBytes: number;
  /** Optional agent-provided title or description */
  caption?: string;
}
