...
async def create_sandbox(
    ...
    scm_user_name: str | None = None,
    scm_user_email: str | None = None,
    ...
    Args:
        ...
        scm_user_name: SCM user name for commit attribution
        scm_user_email: SCM user email for commit attribution
        git_user_name: Deprecated alias for scm_user_name
        git_user_email: Deprecated alias for scm_user_email
    ...
    git_user = None
    resolved_user_name = scm_user_name or git_user_name
    resolved_user_email = scm_user_email or git_user_email
    if resolved_user_name and resolved_user_email:
        git_user = GitUser(name=resolved_user_name, email=resolved_user_email)
