...
export interface Env {
  ...
  E2B_AUTO_PAUSE?: string; // "true" (default) pauses on TTL expiry (resumable) instead of killing
  E2B_AUTO_RESUME?: string; // "true" (default) wakes a paused sandbox on inbound activity
