/**
 * Repository listing and metadata routes.
 */
...
import { listInstallationRepositories, getGitHubAppConfig } from "../auth/github-app";
import { RepoMetadataStore } from "../db/repo-metadata";
import { createLogger } from "../logger";
import type { Env } from "../types";
import { type Route, type RequestContext, parsePattern, json, error } from "./shared";

const logger = createLogger("router:repositories");
