...
const ENV_CONFIG_KEYS = {
  ...
  LINEAR_CLIENT_ID: true,
  LINEAR_CLIENT_SECRET: true,
  LINEAR_WEBHOOK_SECRET: true,
  LINEAR_API_KEY: true,
  OPENAI_API_KEY: true,
  GITHUB_APP_ID: true,
  ...
  SLACK_BOT_DEFAULT_MODEL: true,
  LINEAR_BOT_DEFAULT_MODEL: true,
  GITHUB_BOT_DEFAULT_MODEL: true,
