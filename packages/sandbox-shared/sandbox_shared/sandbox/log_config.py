"""
Structured JSON logging for Open-Inspect sandbox infrastructure.
...
Usage:
    from sandbox_shared.sandbox.log_config import configure_logging, get_logger
...
# Default service name; overridden by each infra package.
_default_service = "sandbox-infra"


def set_default_service(name: str) -> None:
    """Set the default service name for log output (call before configure_logging)."""
    global _default_service
    _default_service = name
...
class JSONFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        output: dict[str, Any] = {
            ...
            "service": getattr(record, "_service", _default_service),
...
class StructuredLogger:
    ...
    def __init__(
        ...
        self._service = service or _default_service
