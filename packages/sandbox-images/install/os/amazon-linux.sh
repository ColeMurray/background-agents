...
cmake -S "$build_dir/libvncserver-LibVNCServer-$LIBVNCSERVER_VERSION" -B "$build_dir/libvncserver-build" -DWITH_GCRYPT=OFF -DWITH_GNUTLS=OFF -DWITH_FFMPEG=OFF -DWITH_PNG=OFF -DWITH_SDL=OFF -DWITH_SYSTEMD=OFF
