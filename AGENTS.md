...
links it prints. `npm run test:preview` runs the real-stack browser regressions. Do not invent a
login bypass, copy production cookies, or mock first-party APIs.
