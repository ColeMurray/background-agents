...
| `anthropic/claude-opus-5-5`   | Claude Opus 5.5   | Latest Opus, adaptive thinking                    | low, medium, high, xhigh, max | medium         |
...
| `openai/gpt-5.6-luna`        | GPT 5.6 Luna        | Fast, cost-efficient high-volume workloads     | none, low, medium, high, xhigh      | medium         |
| `openai/gpt-6-astra`         | GPT-6 Astra         | Most capable model for complex, demanding work | low, medium, high, xhigh, max       | medium         |
| `openai/gpt-6-sol`           | GPT-6 Sol           | Frontier model for complex professional work   | none, low, medium, high, xhigh, max | medium         |
| `openai/gpt-6-luna`          | GPT-6 Luna          | Fast, cost-efficient high-volume workloads     | none, low, medium, high, xhigh, max | medium         |
