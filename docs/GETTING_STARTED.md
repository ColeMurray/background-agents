...
| `MODAL_LAUNCH_CONTRACT_V1_ENABLED` | Optional launch-v1 rollout flag, defaults to `false`; enable only after [receiver/runtime canaries](plans/sandbox-launch-contract-rollout.md) |
