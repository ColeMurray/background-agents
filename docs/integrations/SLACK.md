...
If only one repository is available, Open-Inspect normally uses it directly. Otherwise it classifies
the target from the request. When the match is unclear, Open-Inspect asks you to choose a
