locals {
  ...
  # Web app URL depends on deployment platform. On Cloudflare, honor the
  # custom-domain host; on Vercel, honor our optional Vercel custom domain
  # (agents.bandcizer.io / agents.dreamplan.io) before the default *.vercel.app.
